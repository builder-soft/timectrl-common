...
public class EmployeeData extends BSBean {
	private static final long serialVersionUID = 8795261079442476347L;
	@SuppressWarnings("unused")
	private String TABLE = "tEmployeeData";
	...
	public String toString() {
		return "Employee {Id=" + getId() + ", key=" + key + ", rut=" + rut + ", name=" + name + ", post=" + post + ", area="
				+ area + ", privilege=" + privilege + ", enabled=" + enabled + ", group=" + group + ", mail=" + mail + "}";
	}
}
